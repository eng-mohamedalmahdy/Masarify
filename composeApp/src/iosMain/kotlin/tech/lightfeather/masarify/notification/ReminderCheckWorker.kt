...
class ReminderCheckWorker : IosWorker, KoinComponent {
    ...
    private fun postNotification(type: ReminderType, index: Int) {
    ...
    private fun reminderTitle(type: ReminderType): String = when (type) {
    ...
    private fun reminderBody(type: ReminderType): String = when (type) {
