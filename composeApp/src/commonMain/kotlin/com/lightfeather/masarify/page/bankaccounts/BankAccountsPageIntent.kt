...
internal sealed interface BankAccountsPageIntent {
    data class UpdateBankAccount(val account : UiBankAccount) : BankAccountsPageIntent
    ...
    data class AddBankAccount(val account : UiBankAccount) : BankAccountsPageIntent
