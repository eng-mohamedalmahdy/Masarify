...
data class WidgetCategory(
    ...
    fun getCategoryStringResourceByKey(key: String): StringResource =
        when (key) {
            // Transfer
...
@Composable
fun WidgetCategory.getLocalizedName(): String =
    if (resourceKey != null) {
        val stringRes = this.getCategoryStringResourceByKey(resourceKey)
