...
class CurrencyDatasourceLocalImp(private val currencyQueries: CurrencyQueries) : CurrencyDatasource {
    ...
    override suspend fun updateCurrency(currency: Currency) {
        currencyQueries.updateCurrency(currency.name, currency.sign, currency.id.toLong())
    }
