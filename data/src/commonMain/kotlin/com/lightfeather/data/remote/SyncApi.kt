...
import com.lightfeather.domain.model.sync.SyncedAccountSnapshot
...
private fun FinancialSessionResponseDto.toDomain() =
    SyncedFinancialSession(
        ...
        name = name,
        timestamp = timestamp,
        accountSnapshots = accountSnapshots.map {
...
@Serializable
private data class EnqueueResponseDto(val actionId: String)
